...
router.post('/one-food', async (req, res) => {
    try {
        const { user_id, food_name, food_id: incomingFoodId, serving_id: incomingServingId, serving_size, number_of_servings, fraction_of_serving, calories, carbohydrate, protein, fat, saturated_fat, sodium, fiber, meal_type, brand, food_type = 'api', // default to 'api' for backwards compatibility
         } = req.body;
